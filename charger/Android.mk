...
ifneq ($(BOARD_AC_DEVICE_NAME),)
LOCAL_CFLAGS += -DAC_DEVICE_NAME=\"$(BOARD_AC_DEVICE_NAME)\"
endif

ifneq ($(BOARD_USB_DEVICE_NAME),)
LOCAL_CFLAGS += -DUSB_DEVICE_NAME=\"$(BOARD_USB_DEVICE_NAME)\"
endif
